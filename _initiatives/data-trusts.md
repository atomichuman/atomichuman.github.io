...
This purpose directly addresses a challenge highlighted in *The Atomic Human* - that data protection regulations don't "*directly* protect us regarding the 'inconsequential' decisions" made by platforms that can accumulate to have major effects, a key concern discussed in [yesterday's post on power concentration and automation](/reflections/x-risk-decomposed-power-and-automation/). I agree with the Information Commissioner John Edwards [who suggested that existing data protection legislation could potentially address this](https://medium.com/data-policy/the-atomic-human-understanding-ourselves-in-the-age-of-ai-by-neil-lawrence-df97c47aaa74), but I think the key word is directly, without institutional frameworks like data trusts the rights that data protection confers on us are not practically accessible and effective at scale.
