...
This purpose directly addresses a challenge highlighted in *The Atomic Human* - that data protection regulations don't "directly protect us regarding the 'inconsequential' decisions" made by platforms that can accumulate to have major effects. I agree with the Information Commissioner John Edwards who suggested that existing data protection legislation could potentially address this, but I think the key word is directly, without  institutional frameworks like data trusts the rights that data protection confers on us are not practically accessible and effective at scale.
