...
[^1]: This draft of was a very different book, see [The Atomic Human](/reflections/triple-cooked/) for more details.
<!-- Extra "of" in footnote 1: "This draft of was" should be "This draft was" -->

<!-- Consider breaking this long paragraph into two for readability -->
Prompted by challenges generated by the DeepMind-Royal Free Hospital data sharing agreement, I wrote about the proposal in an article for the Guardian in 2016.[^2] The *purpose* of a data trust is to rebalance the power asymmetry between data controllers and data subjects. The idea of a data trust was to use the legal infastructure associated with trust law, that would be enforced by a court of equity,[^3] to enable a new type of instituion that could  provide governance based on the collectivised rights of data subjects.
<!-- Typos: "infastructure" should be "infrastructure", "instituion" should be "institution" -->
<!-- Double space after "could" -->
...
<!-- Typo: "phenonomen" should be "phenomenon" -->
Back in 2016 I wasn't aware of a phenonomen known as "trust-washing". Sometimes the term "trust" is applied to an institution that borrows the terminology but isn't governed by a court of equity. For example, NHS Trusts are not governed by a court of equity so are not trusts in the legal sense. So when the notion of data trusts was picked up in the wider public domain, it felt like it was often without the original purpose of forming institutions that better reflect the asiprations of their members, and more as a route to trust-washing data processes.
<!-- Typo: "asiprations" should be "aspirations" -->
<!-- Consider removing one "So" - paragraph starts with "So" and has another "so" in middle -->
...
<!-- "Youtube" should be "YouTube" in caption -->
...
<!-- Typo: "Initaitive" should be "Initiative" -->
[The Data Trusts Initaitive](https://datatrusts.uk/) followed on from this work and was funded by the Patrick J. McGovern Foundation. Together with [Jess Montgomery](/people/jessica-montgomery) and [Sylvie Delacroix](/people/sylvie-delacroix) we proposed an initiative that would fund pilot data trusts as well as build a commuity of practice around data trusts with supporting research and policy work. This enabled us to provide easily accessible information, e.g. on the EU's [Data Governance Act](https://datatrusts.uk/2021/01/29/data-trusts-and-the-draft-data-governance-act) or on the mandatability of data rights we receive under GDPR. We also worked with the Ada Lovelace Institute, the AI Council and [to clarify the legal mechanisms behind data stewardship](https://datatrusts.uk/2021/03/04/legal-mechanisms-for-data-stewardship-the-role-of-data-trusts.html).
<!-- Typo: "commuity" should be "community" -->
<!-- Missing word after "AI Council and" - sentence structure incomplete -->
